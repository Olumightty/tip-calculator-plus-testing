...
const Input = ({title, value, setValue, placeholder, logo, label}:{
  ...
  return (
    <fieldset className="flex flex-col relative">
        ...
        <div className={("flex gap-5 items-center px-2 py-2 bg-(--grey-50) rounded-lg  focus-within:outline-2 focus-within:outline-(--green-400)") + " " + (isPeopleZero ? ("outline-2 outline-red-400") : null)}>
